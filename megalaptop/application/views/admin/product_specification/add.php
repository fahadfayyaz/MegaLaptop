              ...
              <div class="row column-seperation">
                  ...
                  <h4>Basic Information</h4>
                    <div class="row form-row">
                      <div class="col-md-12">
                        ...
                        <?php echo form_error('processor_type', '<div class="error">', '</div>'); ?>
                      </div>
                    </div>
                    <div class="row form-row">
                      <div class="col-md-12">
                        ...
                        <?php echo form_error('processor_speed', '<div class="error">', '</div>'); ?>
                      </div>
                    </div>
                    <div class="row form-row">
                      <div class="col-md-12">
                        <input name="hard_drive_size" id="hard_drive_size" type="text"  class="form-control" placeholder="Harddrive Size" value="<?php echo set_value('hard_drive_size'); ?>">
                      </div>
                    </div>
                    <div class="row form-row">
                      <div class="col-md-12">
                        <input name="installed_ram" id="installed_ram" type="text"  class="form-control" placeholder="Installed Ram" value="<?php echo set_value('installed_ram'); ?>">
                      </div>
                    </div>  
                    <div class="row form-row">
                      <div class="col-md-12">
                ...
                <div class="col-md-6">
                  ...
                  <h4>Basic Information</h4>
                    ...
                    <div class="row form-row">
                      <div class="col-md-12">
                        <input name="color" id="color" type="text"  class="form-control" placeholder="Available Color" value="<?php echo set_value('color'); ?>">
                      </div>
                    </div>
                    <div class="row form-row">
                      <div class="col-md-12">
                        <input name="operating_system" id="operating_system" type="text"  class="form-control" placeholder="OS Primary" value="<?php echo set_value('operating_system'); ?>">
                      </div>
                    </div>
                    <div class="row form-row">
                      <div class="col-md-12">
