                ...
                <div class="col-md-6">
                  <h4>Basic Information</h4>            
                    ...
                    <div class="row form-row">
                     ...
                     <div class="row form-row">
                      <div class="col-md-12">
                        <input name="embed_code" id="embed_code" type="text"  class="form-control <?php echo (form_error('embed_code')) ? 'error' : NULL; ?>" placeholder="Embed code" value="<?php echo set_value('embed_code'); ?>">
                        <?php echo form_error('embed_code','<div class="error">', '</div>');  ?>
                      </div>
                    </div>
                </div>
                <div class="col-md-6">
