...
<meta charset="utf-8" />
<title><?php echo $title ?> | Delight Laptop</title>
...
<div class="container">
  <div class="row login-container animated fadeInUp">  
		...
		<div class="tiles grey p-t-20 p-b-20 text-black">
			<?php  
		        $attributes = ['name' => 'formResetPassword', 'id' => 'formResetPassword', 'class' => 'animated fadeIn' ];
		    ...
		    ?>
			    <div class="row form-row m-l-20 m-r-20 xs-m-l-10 xs-m-r-10">
		          ...
		          <div class="col-md-6 col-sm-6">
		            <input name="retype_password" id="retype_password" type="password"  class="form-control" placeholder="Retype Password">
		          </div>
		        </div>
				<div class="row p-t-10 m-l-20 m-r-20 xs-m-l-10 xs-m-r-10">
				  <div class="control-group  col-md-10">
					
          <button type="submit" class="btn btn-primary btn-cons" id="login_toggle">Reset your Password</button>
          </div>
          </div>
			  <?php echo form_close(); ?>
