              ...
              <div class="row column-seperation">
                <div class="col-md-6">
                  <h4>Basic Information</h4>            
                    ...
                    <div class="row form-row">
                      <div class="col-md-12">
                        <input name="slug" id="slug" type="text"  class="form-control  <?php echo form_error('slug') ? 'error' : NULL ?>" placeholder="Slug" readonly value="<?php echo set_value('slug'); ?>">
