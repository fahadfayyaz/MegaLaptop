                    ...
                    <br>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div class="checkbox check-default">
                                        <input id="checkbox<?php echo $brand->id ?>" class="checkParam" type="checkbox" name="checkAll[]" value="<?php echo $brand->id ?>">
                                        <label for="checkbox<?php echo $brand->id ?>"></label>
                                    </div>
                                </td>
                                <td><?php echo $brand->title; ?></td>
                                <td align="center">
                                    <img src="/uploads/<?php echo $brand->brand_img; ?>" width="100" alt="<?php echo $brand->title; ?>" class="img-thumbnail">
                                </td>
                                <td>
	...
	$(document).ready(function() {
       ...
       $("#activeAll").on('click', function(e) {
            ...
            if ($(".checkParam:checked").length > 0 ) 
            {
                ...
                $.post('/admin/brand/activeall', formSerials, function(response) {
                    if (response > 0 ) 
        ...
        $("#deactiveAll").on('click', function(e) {
            ...
            {
                var formSerials = $("#formView").serialize();
                $.post('/admin/brand/deactiveall', formSerials, function(response) {
                    if (response > 0 ) 
                        window.location.href = '/admin/brand';
                });
            }
